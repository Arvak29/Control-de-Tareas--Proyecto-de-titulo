...
export class CrearFlujoDeTareasComponent implements OnInit {
  ...
  crear_flujo_de_tareas() {
    const Flujo: AgregarFlujo = {
      ...
      descripcion_ft:
        this.Crear_Flujo_de_tareas_Grupo.get('descripcion_ft')?.value,
      fecha_inicio_ft:
        this.Crear_Flujo_de_tareas_Grupo.get('fecha_inicio_ft')?.value,
      fecha_entrega_ft:
        this.Crear_Flujo_de_tareas_Grupo.get('fecha_entrega_ft')?.value,
      porcentaje_avance_ft: this.Crear_Flujo_de_tareas_Grupo.get(
